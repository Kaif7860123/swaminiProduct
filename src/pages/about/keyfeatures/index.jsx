...
import Features from '../../../components/HomeFeatues/Features'
import Container from '../../../container'
function KeyFeatures() {
  return (
    <>
    <Container>
      <div className={styles.keyfeatureCont}>
      ...
      <Features num= "02" desc="Unique and high-quality production with 100% results."/>
